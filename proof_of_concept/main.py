...
def main():
    ...
    # Load or generate cell type assignments
    cell_type_assignments = load_cell_type_assignments(args.cell_types_data, cell_ids)
    
    # Get unique cell types
    cell_types = list(set(cell_type_assignments.values()))
    
    # Load or generate prior GRNs
    prior_grns = load_prior_grns(args.prior_grns_data, genes, cell_types)
    ...
    # Train the model with time-based split
